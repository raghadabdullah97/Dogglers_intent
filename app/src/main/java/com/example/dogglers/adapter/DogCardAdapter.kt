...
class DogCardAdapter(
    ...
    class DogCardViewHolder( view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val NameDog : TextView = view!!.findViewById(R.id.namedog)
        val DogAge : TextView = view!!.findViewById(R.id.agedog)
        val HobbiesDog : TextView = view!!.findViewById(R.id.Hobbe)
    }
